<%@ Page Title="" Language="C#" MasterPageFile="~/edcMaster.Master" AutoEventWireup="true" CodeBehind="Reporte10.aspx.cs" Inherits="CatalogosLTH.Web.Reporte10" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <ul class="nav nav-pills nav-justified">
    ...
    <li class=""><a href="tablero2.aspx">Tablero 2</a></li>
    ...
    <li class="active"><a href="reporte10.aspx">Actividades mensuales por distribuidor</a></li>
    ...
    <div class="container">
        ...
        <div class="row" style="margin-top:5%">
            <div class="col-sm-10">
                <dx:ASPxGridView ID="gridAvanceActividades" Theme="ThemeLTH" runat="server" EnableRowsCache="False"></dx:ASPxGridView>
            </div>
            
        </div>
        <div class="row">
            <div class="col-sm-3">
                <dx:ASPxButton ID="btnExcel" Theme="ThemeLTH" runat="server" Text="Exportar a excel"  CssClass="btn btn-success" OnClick="btnExcel_Click" HorizontalAlign="Right"></dx:ASPxButton>
