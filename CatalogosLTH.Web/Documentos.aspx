<%@ Page Title="" Language="C#" MasterPageFile="~/edcMaster.Master" AutoEventWireup="true" CodeBehind="Documentos.aspx.cs" Inherits="CatalogosLTH.Web.Documentos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    function encripta(plain) {
        window.location.href = 'DetalleDocumento.aspx?iddoc=' + plain;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        <div class="row">
            <dx:ASPxGridView ID="grdDocs" runat="server" EnableRowsCache="true" Theme="ThemeLTH">
