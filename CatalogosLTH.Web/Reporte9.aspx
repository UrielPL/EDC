...
<%@ Page Title="" Language="C#" MasterPageFile="~/edcMaster.Master" AutoEventWireup="true" CodeBehind="Reporte9.aspx.cs" Inherits="CatalogosLTH.Web.Reporte9" %>
  ...
  <ul class="nav nav-pills nav-justified">
    ...
    <li><a href="reporte8.aspx">Profesionalización mensual y actividades completadas por zona</a></li>
      <%} %>  
              ...
              <li class="active"><a href="reporte9.aspx">Profesionalización mensual y actividades completadas por distribuidor</a></li>
    ...
    <div class="container">
        ...
        <div class="col-sm-12">
            <div class="row">
                <div class="col-sm-4">
                    <dx:ASPxComboBox ID="cmbYear" runat="server" AutoPostBack="true" ValueType="System.String" OnSelectedIndexChanged="cmbYear_SelectedIndexChanged" Theme="ThemeLTH"></dx:ASPxComboBox>
                </div>
                <div class="col-sm-4">
                    <asp:DropDownList ID="dropDist" runat="server" AutoPostBack="True" OnSelectedIndexChanged="dropDist_SelectedIndexChanged" Theme="ThemeLTH"></asp:DropDownList>
                </div>                
            </div>
            <div class="row" style="margin-top:5%">
                <dx:ASPxGridView ID="TablaProfesionalizacion" runat="server" Theme="ThemeLTH"></dx:ASPxGridView>
            </div>  
            <div class="row" style="margin-top:5%">
                 <div class="col-sm-3">                    
                     <div class="col-sm-1"><dx:ASPxButton ID="btnExcel" Theme="ThemeLTH" runat="server" Text="Exportar a excel"  CssClass="btn btn-success" OnClick="btnExcel_Click" HorizontalAlign="Right"></dx:ASPxButton></div>
                </div>
                <div class="col-sm-2">
