<%@ Page Title="" Language="C#" MasterPageFile="~/edcMaster.Master" AutoEventWireup="true" CodeBehind="AuditoriaLubricantes.aspx.cs" Inherits="CatalogosLTH.Web.AuditoriaLubricantes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                url: '<%=ResolveUrl("AuditoriaLubricantes.aspx/traeTablaF")%>',
            ...
            $.ajax({
                url: '<%=ResolveUrl("AuditoriaLubricantes.aspx/traePuntos")%>',
                contentType: "application/json; charset=utf-8",
                dataType: 'json',
                type: 'POST',
                async: false,
        ...
        function abreCondiciones(x, np) {
            console.log(x);
            $.ajax({
                url: "<%= ResolveUrl("AuditoriaLubricantes.aspx/traeCondiciones")%>",
                type: "POST",
                //cache: false,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function chResponsable() {
            ...
            $.ajax({
                url: '<%=ResolveUrl("AuditoriaLubricantes.aspx/PuntoxResp")%>',
                contentType: "application/json; charset=utf-8",
                dataType: 'json',
                type: 'POST',
                async: false,
        ...
        function ajaxTabla(aud, r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, ubruta, vneta, uoperativa, vneta2, acirc, pcirc, acinv, pcirc2, inv, cvdias, cxc, vcredper, cxp, cvper, ptot, atot, goper, vnet, uoper, atotpas, b64, filename, completos){
            $.ajax({
                url: '<%=ResolveUrl("AuditoriaLubricantes.aspx/guardaTabla")%>',
                contentType: "application/json; charset=utf-8",
                dataType: 'json',
                type: 'POST',
                async: false,
        ...
        function guardaDatos(){
            ...
            $.ajax({
                url: '<%=ResolveUrl("AuditoriaLubricantes.aspx/saveDatos")%>',
                contentType: "application/json; charset=utf-8",
                dataType: 'json',
                type: 'POST',
                ...
                success: function (response) {
                    ...
                    if(json != -1){
                        ...
                        if(aud == null || aud == ""){
                            location.href = "AuditoriaLubricantes.aspx?aud=" + json;
                        }
         ...
         function finalizaAud(){
           ...
           $.ajax({
                url: '<%=ResolveUrl("AuditoriaLubricantes.aspx/finaliza")%>',
                contentType: "application/json; charset=utf-8",
                dataType: 'json',
                type: 'POST',
                data: JSON.stringify(datos),
        ...
        function checaPendientes(){
            $.ajax({
                url: '<%=ResolveUrl("AuditoriaLubricantes.aspx/checaPendientes")%>',
                contentType: "application/json; charset=utf-8",
                dataType: 'json',
                type: 'POST',
                async: false,
