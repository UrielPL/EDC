<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/edcMaster.Master" CodeBehind="ActividadesPorRevisar.aspx.cs" Inherits="CatalogosLTH.Web.ActividadesPorRevisar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>
        ...
        $(document).ready(function () {
            changeDist();
            <%--$.ajax({
                url: '<%=ResolveUrl("ActividadesPorRevisar.aspx/getDistribuidores")%>',
           ...
           <%-- var distSelected = $('#drop_dist option:selected').text();
            ...
            $.ajax({
                url: '<%=ResolveUrl("ActividadesPorRevisar.aspx/getActividades")%>',
                contentType: "application/json; charset=utf-8",
                dataType: 'json',
                type: 'POST',
                async: false,
        ...
        function changeDist() {
            //var distSelected = $('#drop_dist option:selected').text();
            //console.log(distSelected);
            var tabla = $('#tbl_actividades');
            console.log(tabla);
            
            $.ajax({
                url: '<%=ResolveUrl("ActividadesPorRevisar.aspx/getActs")%>',
                contentType: "application/json; charset=utf-8",
                dataType: 'json',
                type: 'POST',
                async: false,
