<%@ Page Title="" Language="C#" MasterPageFile="~/edcMaster.Master" AutoEventWireup="true" CodeBehind="CreaAuditoria.aspx.cs" Inherits="CatalogosLTH.Web.CreaAuditoria" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container" style="margin-top: 40px">
                                        ...
                                        <li id="li<%=punto.idpunto %>" class="cd-accordion__item cd-accordion__item--has-children lipunto ">
                                            <div class="row" style="display: flex">
                                                ...
                                                <div class="col-sm-1" style="display: flex; align-items: center; justify-content: center;">
                                                    <div class="noAplica" style="display: block ruby">
                    ...
                    <table border="1" class="table table-bordered table-striped  table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td rowspan="2">
                                    <input id="r1" type="text" style="font-size: 18px; font-weight: 400;" />
                                </td>
                            </tr>
                            <tr>
                                <td>V NETAS</td>
                                <td>
                                    <input type="text" id="vneta" value="0" onkeyup="Calc1()" /></td>
                            </tr>
                            <!-- CALC 2-->
                            <tr>
                            ...
                            <tr>
                                ...
                                <td rowspan="2">
                                    <input id="r3" type="text" style="font-size: 18px; font-weight: 400;" step="0.0001" />
                                </td>
                            </tr>
                            <tr>
                                <td>PAS CIRC</td>
        ...
        <div>
            ...
            <input id="saveDatos" type="button" class="btn btn-success" value="Guardar Auditoria" onclick="guardaDatos()" />
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        if('<%=estatus%>' == 'INCOMPLETO' || '<%=estatus%>' == ''){
            function iniciarAutoGuardado() {
                ...
                autoSaveTimer = setInterval(function () {
                    $('#saveDatos').click();
                }, 300000); // Autoguardar cada 5 minutos
            }
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                url: '<%=ResolveUrl("CreaAuditoria.aspx/traeTablaF")%>',
            ...
            $.ajax({
                url: '<%=ResolveUrl("CreaAuditoria.aspx/traePuntos")%>',
                contentType: "application/json; charset=utf-8",
                dataType: 'json',
                type: 'POST',
                async: false,
        ...
        <%--$("input").click(function(){
            $.ajax({
                url: "<%= ResolveUrl("CreaAuditoria.aspx/checkSess")%>",
                type: "POST",
                //cache: false,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
                    ...
                    if(json == -1){
                        alert("Sesion caduca. Vuelve a iniciar sesion");
                    }
                }
            });
        });--%>
        ...
        function clickCheck() {
            ...
            var checkna = $(".noAplica :checkbox").length;
            console.log(checkna);
            //console.log("cuan" + checkall);

            $(".noAplica :checkbox").each(function(k){
        ...
        function abreCondiciones(x, np) {
            console.log(x);
            $.ajax({
                url: "<%= ResolveUrl("CreaAuditoria.aspx/traeCondiciones")%>",
                type: "POST",
                //cache: false,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function chResponsable() {
            ...
            $.ajax({
                url: '<%=ResolveUrl("CreaAuditoria.aspx/PuntoxResp")%>',
                contentType: "application/json; charset=utf-8",
                dataType: 'json',
                type: 'POST',
                async: false,
        ...
        function ajaxTabla(aud, r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, ubruta, vneta, uoperativa, vneta2, acirc, pcirc, acinv, pcirc2, inv, cvdias, cxc, vcredper, cxp, cvper, ptot, atot, goper, vnet, uoper, atotpas, b64, filename, completos){
            $.ajax({
                url: '<%=ResolveUrl("CreaAuditoria.aspx/guardaTabla")%>',
                contentType: "application/json; charset=utf-8",
                dataType: 'json',
                type: 'POST',
                async: false,
        ...
        function guardaDatos(){
            ...
            $.ajax({
                url: '<%=ResolveUrl("CreaAuditoria.aspx/saveDatos")%>',
                contentType: "application/json; charset=utf-8",
                dataType: 'json',
                type: 'POST',
                ...
                success: function (response) {
                    ...
                    if(json != -1 && json !=-2){
                        ...
                        Swal.fire({
                            ...
                            text:'Auditoria guardada exitosamente',
                            icon:'success',
                        ...
                        if(aud == null || aud == ""){
                            location.href = "CreaAuditoria.aspx?aud=" + json;
                        }
                        ...
                        alert("Sesion caduca. Vuelva a iniciar sesion");
                    }
                    else{
         ...
         function finalizaAud(){
           ...
           $.ajax({
                url: '<%=ResolveUrl("CreaAuditoria.aspx/finaliza")%>',
                contentType: "application/json; charset=utf-8",
                dataType: 'json',
                type: 'POST',
                data: JSON.stringify(datos),
        ...
        function checaPendientes(){
            $.ajax({
                url: '<%=ResolveUrl("CreaAuditoria.aspx/checaPendientes")%>',
                contentType: "application/json; charset=utf-8",
                dataType: 'json',
                type: 'POST',
                async: false,
