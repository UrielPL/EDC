<%@ Page Title="" Language="C#" MasterPageFile="~/edcMaster.Master" AutoEventWireup="true" CodeBehind="Reporte4.aspx.cs" Inherits="CatalogosLTH.Web.Reporte4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <ul class="nav nav-pills nav-justified">
    ...
    <li  class="active"><a href="reporte4.aspx">Reporte actividades completadas</a></li><%} %>  
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="row" align="center">
            <dx:ASPxGridView ID="ASPxGridView1" runat="server" Width="60%" Theme="ThemeLTH"></dx:ASPxGridView>
            </div>
        </div>
</asp:Content>
