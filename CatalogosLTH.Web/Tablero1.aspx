<%@ Page Title="" Language="C#" MasterPageFile="~/edcMaster.Master" AutoEventWireup="true" CodeBehind="Tablero1.aspx.cs" Inherits="CatalogosLTH.Web.Tablero1" %>
        ...
        <div class="col-md-12">
            <div class="container-fluid" style="padding:3% 0% 3% 0%">
                <ul class="nav nav-pills nav-justified">
                    <li class="active"><a href="tablero1.aspx">Tablero 1</a></li>
            ...
            <div class="col-sm-12">
                <div class="row">
                    <div class="table-responsive">
                        <dx:ASPxGridView ID="ASPxGridView1" runat="server" Theme="ThemeLTH">
                ...
                <div class="row">
                     <div class="col-sm-3">                    
                         <dx:ASPxButton ID="ASPxButton1" runat="server" Text="Exporta Excel" CssClass="btn btn-default" OnClick="Excel"></dx:ASPxButton>
                    </div>
                <div class="col-sm-2">
